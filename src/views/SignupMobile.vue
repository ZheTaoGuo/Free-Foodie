                ...
                <div class="col-md-12">
                    <div class="h-100">
                        ...
                        <div class="form-floating mx-auto mb-3 col-6">
                            ...
                            <div id="family-id-text" class="text-start ms-1">
                                If you are a new user, please leave this field blank. You can retrieve your family referral code on your profile.
                            </div>
                        </div>
                        ...
                        <div class="mt-5">
                            ...
                            <div class="form-floating mx-auto mb-3 col-6">
                                ...
                                <div id="passwordHelpBlock" class="form-text text-danger" v-if="passwordInvalid">
                                    Your password must be 8 characters or longer, contain letters, numbers, and special characters and must
